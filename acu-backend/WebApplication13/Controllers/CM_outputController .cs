...
namespace WebApplication13.Controllers
{
    ...
    public class CM_outputController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("NewCM_output/{user_id}")]
        public IActionResult NewCM_output(NewCM_OutputViewModel value, [FromRoute]Guid user_id)
        {
        ...
        #region  總覽中藥診斷
        [HttpGet]
        [Route("GetCM_Output/{user_id}")]
        public IActionResult GetCM_Output([FromRoute] Guid user_id)
        {
