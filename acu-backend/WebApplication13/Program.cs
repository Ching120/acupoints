...
builder.Services.AddSingleton<CM_questionDBService>();
builder.Services.AddSingleton<Historical_RecordDBService>();
builder.Services.AddSingleton<WarningDBService>();
