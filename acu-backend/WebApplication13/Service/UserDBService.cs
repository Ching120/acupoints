    ...
    public class UserDBService
    {
        ...
        public void Register(UserRegisterViewModel newMember, string AuthCode)
        {
            ...
            sql = @"INSERT INTO ""user"" ( user_id, user_account,  user_password,user_name, user_gender, user_age,  user_authcode,user_start, user_level,
                    isdel,create_id,create_time,update_id,update_time) VALUES (@user_id, @user_account,@user_password,@user_name,@user_gender,@user_age,@user_authcode, @user_start,@user_level,@isdel,@create_id,@create_time,@update_id ,@update_time)";
        ...
        public GetAccountViewModel GetAccountData(string Account)
        {
            SqlConnection conn = new SqlConnection(connectionString);
            GetAccountViewModel Data = new GetAccountViewModel();
            //Sql 語法
